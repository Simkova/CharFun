...
plotGraf(function(t) cfN_GeneralizedPoisson(t, a, p), t, title = "CF of the Generalized-Poisson distribution with a = 10, p = 0.5")
...
t <- seq(-10, 10, length.out = 501)
plotGraf(function(t) cfN_GeneralizedPoisson(t, a, p, cfX), t, title = "CF of the compound Generalized-Poisson-Exponential distribution")
...
lambda <- 5
cfX <- function(t) cfX_Exponential(t, lambda)
cf <- function(t) cfN_GeneralizedPoisson(t, a, p, cfX)
