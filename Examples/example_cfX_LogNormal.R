...
plotGraf(function(t) cfX_LogNormal(t, mu, sigma), t, title = "Characteristic function of the Lognormal distribution")
...
result <- cf2DistGP(cf, x, prob, N = 2^13, SixSigmaRule = 8, xMin = 0)
