...
plotGraf(function(t) cfN_Delaporte(t, a, b, c), t, title = "CF of the Delaporte distribution with a=2.2, b=3.3, c=4")
...
plotGraf(function(t) cfN_Delaporte(t, a, b, c, cfX), t, title = "CF of the compound Delaport-Exponential distribution")
...
lambda <- 5
cfX <- function(t) cfX_Exponential(t, lambda)
cf <- function(t) cfN_Delaporte(t, a, b, c, cfX)
