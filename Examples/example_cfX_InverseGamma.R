## EXAMPLE1 (CF of the InverseGamma distribution with alpha = 2, beta = 2)
  ...
  plotGraf(function(t) cfX_InverseGamma(t, alpha, beta), t, title = "CF of the InverseGamma distribution with alpha = 2, beta = 2")

## EXAMPLE2 (PDF/CDF of the InverseGamma distribution with alpha = 2, beta = 2)
  alpha <- 2
  beta <- 2
  cf <- function(t) cfX_InverseGamma(t, alpha, beta)
...
## EXAMPLE3 (PDF/CDF of the compound Binomial-InverseGamma distribution)
  ...
  alpha <- 2
  beta <- 2
  cfX <- function(t) cfX_InverseGamma(t, alpha, beta)
