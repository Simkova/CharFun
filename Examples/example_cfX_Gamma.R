## EXAMPLE1 (CF of the Gamma distribution with alpha = 2, beta = 2)
 ...
 plotGraf(function(t) cfX_Gamma(t, alpha, beta), t, title = "CF of the Gamma distribution with alpha = 2, beta = 2")

## EXAMPLE2 (PDF/CDF of the Gamma distribution with alpha = 2, beta = 2)
 alpha <- 2
 beta <- 2
 cf <- function(t) cfX_Gamma(t, alpha, beta)
...
## EXAMPLE3 (PDF/CDF of the compound Binomial-Gamma distribution)
 ...
 alpha <- 2
 beta <- 2
 cfX <- function(t) cfX_Gamma(t, alpha, beta)
