...
plotGraf(function(t) cfN_Poisson(t, lambda), t, title = "CF of the Poisson distribution with the parameter lambda = 10")
...
t <- seq(-10, 10, length.out = 501)
plotGraf(function(t) cfN_Poisson(t, lambda1, cfX), t, title = "CF of the compound Poisson-Exponential distribution")
